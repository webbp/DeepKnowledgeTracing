...
function DataAssistMatrix:__init(params) 
	print('Loading hodoo world interaction by learner data...')
	--train
	local root = '../data/hodoo_wi_bylearner/'
	local trainPath = root .. 'hodoo_wi_bylearner_train.csv'
	...
	--test
	local testPath = root .. 'hodoo_wi_bylearner_test.csv'
...
function DataAssistMatrix:loadStudent()
	...
	local student = {}
	student['questionId'] = torch.zeros(n):short()
	...
	student['correct'] = torch.zeros(n):short()
