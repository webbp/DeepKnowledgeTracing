...
function DataAssistMatrix:__init(params) 
	print('Loading hodoo world interaction by session data...')
	--train
	local root = '../data/hodoo_wi_bysession/'
	local trainPath = root .. 'hodoo_wi_bysession_train.csv'
	...
	--test
	local testPath = root .. 'hodoo_wi_bysession_test.csv'
